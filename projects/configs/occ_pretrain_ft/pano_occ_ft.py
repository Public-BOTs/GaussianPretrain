...
# ===> bus - IoU = 48.89
# ===> car - IoU = 54.64
# ===> construction_vehicle - IoU = 23.32
# ===> motorcycle - IoU = 31.39
# ===> pedestrian - IoU = 29.57
# ===> traffic_cone - IoU = 30.47
# ===> trailer - IoU = 35.14
# ===> truck - IoU = 41.82
# ===> driveable_surface - IoU = 83.89
# ===> other_flat - IoU = 47.57
# ===> sidewalk - IoU = 56.43
# ===> terrain - IoU = 58.51
# ===> manmade - IoU = 48.39
# ===> vegetation - IoU = 42.43
# ===> mIoU of 6019 samples: 42.62
...
plugin = True
plugin_dir = ['projects/panoocc/', "projects/mmdet3d_plugin/"]
...
unified_voxel_size = [0.4, 0.4, 1.6]      # 这里我需要把voxel-shape 在高度上放大，所以voxel-size要小
unified_voxel_shape = [
...
occ_gt_data_root='path_to_occ_gt_path'
...
load_from = 'path_to_pretrain.pth'
log_config = dict(
    interval=50,
    hooks=[
