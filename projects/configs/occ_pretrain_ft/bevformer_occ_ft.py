...
# ===> pedestrian - IoU = 16.93
# ===> traffic_cone - IoU = 17.1
# ===> trailer - IoU = 13.83
# ===> truck - IoU = 27.03
# ===> driveable_surface - IoU = 54.09
# ===> other_flat - IoU = 32.36
# ===> sidewalk - IoU = 33.02
# ===> terrain - IoU = 27.05
# ===> manmade - IoU = 20.39
# ===> vegetation - IoU = 18.16
# ===> mIoU of 6019 samples: 24.21
...
plugin = True
plugin_dir = 'projects/bevformer_occ/'
