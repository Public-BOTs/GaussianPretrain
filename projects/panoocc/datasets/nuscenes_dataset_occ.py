...
from projects.bevformer_occ.datasets.nuscnes_eval import NuScenesEval_custom
from projects.bevformer_occ.datasets.occ_metrics import Metric_mIoU, Metric_FScore
from projects.bevformer_occ.datasets.pipelines.compose import CustomCompose
...
class NuScenesOcc(NuScenesDataset):
    ...
    def evaluate_miou(self, occ_results, runner=None, show_dir=None, **eval_kwargs):
        ...
        for index, occ_pred in enumerate(tqdm(occ_results)):
            ...
            if isinstance(occ_pred, torch.Tensor):
